                            ...
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="min-w-125px">Postcode</th>
                                        <th class="min-w-125px">Address</th>
                                        <th class="min-w-125px">Address1</th>
                                        <th data-ordering="false">Created Date</th>
                                        <!-- <th data-ordering="false">Lasr Updated Date</th> -->
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                <abbr class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item edit-item-btn edit" data-url="{{ route('admin.customer.edit',$customer->id) }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                        <li>
                                                            <a class="dropdown-item remove-item-btn delete" data-id="{{ $customer->id }}" data-url="{{ url('admin/customers/'.$customer->id) }}">
