                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    @php $i = 1 @endphp
                                    @foreach($postalCode as $postal)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $postal->code }}</td>
                                        <td>{{ $postal->created_at }}</td>
                                        <td>{{ $postal->updated_at }}</td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item edit-item-btn edit" data-url="{{ route('admin.post_code.edit',$postal->id) }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn delete" data-id="{{ $postal->id }}" data-url="{{ url('admin/post-code/'.$postal->id) }}">
