                            ...
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $section->name }}</td>
                                        <td><img height="60px" width="60px" src='{{ asset("public/".$section->icon) }}' /></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item edit-item-btn edit" data-url="{{ route('admin.section.edit',$section->id) }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn delete" data-id="{{ $section->id }}" data-url="{{ url('admin/section/'.$section->id) }}">
