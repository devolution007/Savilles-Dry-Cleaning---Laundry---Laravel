                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">
                                Edit Page -> {{ old('title', $page->title) }}
                            </h4>
                        </div><!-- end card header -->
                            ...
                            <div class="live-preview">
                                ...
                                <form method="POST" action="{{ route('admin.pages.update', $page->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug', $page->slug) }}" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($page->thumbnail)
                                        <img src="{{ asset('public/thumbnails/'.$page->thumbnail) }}" alt="Thumbnail" class="img-thumbnail mt-2" style="max-width: 200px;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="main_text_body" id="main_text_body" class="form-control">{!! old('main_text_body', $page->main_text_body) !!}</textarea>
                                    </div>
...
<script>
    ...
    try {
        CKEDITOR.replace('main_text_body', {
            language: 'en',
            filebrowserUploadUrl: "{{ route('admin.pages.upload-ckimage', ['_token' => csrf_token()]) }}",
    ...
    // Get references to title and slug input fields
        var titleInput = document.getElementById('title');
        var slugInput = document.getElementById('slug');

    // Event listener for 'input' event on title field
