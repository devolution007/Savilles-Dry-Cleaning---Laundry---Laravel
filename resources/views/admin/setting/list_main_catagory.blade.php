        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Main Categories list</li>
                            </ol>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.setting.main_catagory') }}" class="btn btn-primary mx-4 float-right" style="float: right;" data-key="t-chat"> Add New Main Catagory </a>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                                            ...
                                            <div class="dropdown d-inline-block">
                                                <abbr class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item edit-item-btn edit" data-url="{{ route('admin.setting.edit_catagory',$category->id) }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                        <li>
                                                            <a class="dropdown-item remove-item-btn delete" data-id="{{ $category->id }}" data-url="{{ url('admin/setting/delete-catagory/'.$category->id) }}">
