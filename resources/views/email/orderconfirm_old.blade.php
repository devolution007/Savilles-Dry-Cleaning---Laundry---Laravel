{{-- <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p>Thank you for choosing Savilles Dry Cleaning & Laundry! We are pleased to confirm that your booking has been successfully scheduled.</p>
    <p><b>Booking Details:</b></p>
    <p><b>Date: {{ date("d.m.Y", strtotime($order['collection_date'])) }}</b></p>
    <p><b>Time: {{ $order['collection_time'] }}</b></p>
    <p><b>Collection Location:{{ $customer["address"].' '.$customer["address_1"].' '.$customer["city"].' '.$customer['postcode'] }}</b></p>
    <p>If you have any questions or need to make any changes to your booking, please don't hesitate to contact us at 01932863248.</p>
                        ...
                        <tbody>
                          <tr>
                            <td align="center" style="color:#2E3C90;padding-top:10px;">
                              <img src="{{ asset('public/images/email/hikdev.jpg') }}" class="fullwidth" width="500" style="color:#29333D;width:100%; max-width:100%; height:auto; border-top-right-radius:30px; border-top-left-radius:30px" mc:edit="RTEDITABLFMA3">
                            </td>
                          </tr>
                          <tr>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td align="center" style="color:#6A6D73; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:300; font-size:15px; line-height:25px; letter-spacing:0px; text-align:center; padding-bottom:30px">
                                      Thank you for choosing Savilles Dry Cleaning & Laundry! We are pleased to confirm that your booking <br/>has been <span style="font-weight:600; color:#ffbf3f">successfully scheduled</span>.
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td align="center">
                                      <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate; mso-table-lspace:0pt; mso-table-rspace:0pt; max-width:500px; border:1px solid #f1f4f6; border-radius:20px;">
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="center" colspan="2" bgcolor="#F3F7FF" style="color:#29333D; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:300; font-size:15px; line-height:26px; letter-spacing:0px; border-bottom:1px solid #FFFFFF;  padding:10px 20px 10px 20px" mc:edit="REGRT22JMC046">
                                              <span style="font-weight:600">ADDRESS: </span> {{$customer["address"].' '.$customer["address_1"].' '.$customer["city"]}}
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" colspan="2" bgcolor="#F3F7FF" style="color:#29333D; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:300; font-size:15px; line-height:26px; letter-spacing:0px; border-bottom:1px solid #FFFFFF;  padding:10px 20px 10px 20px" mc:edit="REGRT22JMC046">
                                              <span style="font-weight:600">POSTCODE: </span> {{$customer['postcode']}}
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" colspan="2" bgcolor="#F3F7FF" style="color:#29333D; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:300; font-size:15px; line-height:26px; letter-spacing:0px; border-bottom:1px solid #FFFFFF;  padding:10px 20px 10px 20px" mc:edit="REGRT22JMC046">
                                              <span style="font-weight:600">PICK UP DATE & DATE: </span> {{ date("d.m.Y", strtotime($order['collection_date'])) }} - {{ $order['collection_time'] }}
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" colspan="2" bgcolor="#F3F7FF" style="color:#29333D; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:300; font-size:15px; line-height:26px; letter-spacing:0px; border-bottom-right-radius:20px; border-bottom-left-radius:20px; padding:10px 20px 20px 20px" mc:edit="REGRT22JMC046">
                                              <span style="font-weight:600"> DROP OFF DATE & TIME: </span> {{ date("d.m.Y", strtotime($order['delivery_date'])) }} - {{ $order['delivery_time'] }}
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                          ...
                          <tr>
                            <td bgcolor="#FAFAFA" align="center" style="padding:35px 45px 35px 45px">
                              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; max-width:100%;">
                                <tbody>
                                  <tr>
                                    <td align="left" style="color:#161616; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:700; font-size:18px; line-height:32px; text-align:left; letter-spacing:0px; padding-bottom: 10px;" class="txt-center" mc:edit="RTRID22MR4M03">
                                  ...
                                  <tr>
                                    <td align="left" style="color:#6A6D73; font-family:'Poppins', Arial, Verdana, Helvetica Neue, Helvetica, sans-serif !important; font-weight:300; font-size:15px; line-height:25px; letter-spacing:0px; text-align:left; padding-bottom: 10px;" class="txt-center">
                                      If you have any questions or need to make any changes to your booking, please don't hesitate to contact us at [emai].
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
